...
public class MainTopAdapter extends FragmentBaseAdapter{
	...
	public MainTopAdapter(BaseActivity context, AbsListView listView, BaseFragment ft) {
...
//			holder.item_num =  (TextView) convertView.findViewById(R.id.tv_num);
		...
		holder.item_download_btn.setOnClickListener(new OnClickListener() {
			public void onClick(final View arg0) {
					...
					new Handler().postDelayed(new Runnable() {
						...
						public void run() {
							...
							DownloadUtil.downloadClick(context,
									preferencesUtils, bean.getId(),-3,bean.getCategoryId(),
				...
				DownloadUtil.downloadClick(context, preferencesUtils,
						bean.getId(), -3,bean.getCategoryId(),bean.getName(), bean.getDownloadUrl(),
						bean.getPackageName(), bean.getIcon(),
