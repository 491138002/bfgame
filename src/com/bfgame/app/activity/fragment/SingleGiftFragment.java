...
public class SingleGiftFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView == null) {
			...
			// setting adapter
			adapter = new SingleGiftAdapter((BaseActivity) getActivity(),
					listView, this);
	...
	public void addGift(Gift gift) {
		boolean isAdd = true;
		initSaveGiftList();
//		for (int i = 0; i < saveGiftList.size(); i++) {
//			if (saveGiftList.get(i).getPackageName()
//					.equals(gift.getPackageName())) {
//				isAdd = false;
//				saveGiftList.remove(i);
//				saveGiftList.add(i, gift);
//				break;
//			}
//		}
		if (isAdd)
