...
public class NumberUtils {
	 ...
	 *            取精度位数
	 * @param roundingMode
	 *            精度计算后的数据 示例 round(1.000000, 2 , BigDecimal.ROUND_HALF_UP)
	 * @return
	 */
	 ...
	 * @return
	 */
	public static String getResult(int some, int total) {
		String result="";
		if (total == 0) {
			return null;
		}
