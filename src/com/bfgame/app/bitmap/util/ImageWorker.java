...
package com.bfgame.app.bitmap.util;
...
//        LogUtil.d("sd card space", String.valueOf(DeviceUtil.getInternalStorageSpace()));
        if(DeviceUtil.getInternalStorageSpace() < 50 && System.currentTimeMillis() - preToastTime < 10000){
...
//            imageView.setTag(R.id.cache_tag, asyncDrawable);
    ...
    public BitmapDrawable getImageDrawable(String url){
    	BitmapDrawable value = null;
...
//        mLoadingBitmap = BitmapFactory.decodeResource(mResources, resId);
        mLoadingBitmap = getTransparentBitmap(Bitmap.createBitmap(10, 10, Config.RGB_565), 0);
    }
...
//        	final Object drawable = imageView.getTag(R.id.cache_tag);
    ...
    private static class AsyncDrawable extends BitmapDrawable {
        ...
        public AsyncDrawable(Resources res, Bitmap bitmap, BitmapWorkerTask bitmapWorkerTask, int rsid) {
            super(res, bitmap);
...
//                    new BitmapDrawable(mResources, mLoadingBitmap));
            imageView.setBackgroundDrawable(mResources.getDrawable(defaultRsId));
